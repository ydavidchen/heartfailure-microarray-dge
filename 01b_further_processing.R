...
## Export:
save(list=c("expr","meta", "pca"), file=paste0(DIR,"230115_objects.RData"), compress=TRUE) 
write.csv(expr, paste0(DIR,"230115_expression.csv"), row.names=TRUE, quote=FALSE)
write.csv(meta, paste0(DIR,"230115_clin.csv"), row.names=FALSE, quote=FALSE)
